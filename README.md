...
- dbt Core 1.10.x  
- dbt-duckdb 1.10.x  
- DuckDB 1.10.x (file-based warehouse)  
...
All commands below assume you are in the **dbt project directory**:
...
```yaml
    saas_analytics_platform:
      ...
      outputs:
        dev:
          type: duckdb
          path: "warehouse/sql/analytics.duckdb"
          threads: 4
```
...
```python
    ...
    con = duckdb.connect("warehouse/sql/analytics.duckdb")
